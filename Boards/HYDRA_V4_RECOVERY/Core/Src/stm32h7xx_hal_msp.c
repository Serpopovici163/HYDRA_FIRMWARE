...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    PB1     ------> ADC1_INP5
    */
    GPIO_InitStruct.Pin = V_SENSE_VCC_Pin|I_SENSE_MAIN_Pin|V_SENSE_PYRO_POST_SW_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = V_SENSE_3V3_Pin|V_SENSE_PYRO_PRE_SW_Pin|V_SENSE_DROGUE_Pin|V_SENSE_MAIN_Pin
                          |I_SENSE_DROGUE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = I_SENSE_3V3_Pin|I_SENSE_5V_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PB1     ------> ADC1_INP5
    */
    HAL_GPIO_DeInit(GPIOC, V_SENSE_VCC_Pin|I_SENSE_MAIN_Pin|V_SENSE_PYRO_POST_SW_Pin);

    HAL_GPIO_DeInit(GPIOA, V_SENSE_3V3_Pin|V_SENSE_PYRO_PRE_SW_Pin|V_SENSE_DROGUE_Pin|V_SENSE_MAIN_Pin
                          |I_SENSE_DROGUE_Pin);

    HAL_GPIO_DeInit(GPIOB, I_SENSE_3V3_Pin|I_SENSE_5V_Pin);
