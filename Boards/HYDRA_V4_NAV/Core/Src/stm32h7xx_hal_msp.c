...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PB1     ------> ADC1_INP5
    */
    GPIO_InitStruct.Pin = V_SENSE_5V_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(V_SENSE_5V_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = V_SENSE_ACT_PWR_Pin|I_SENSE_ACT_PWR_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = I_SENSE_3V3_Pin|V_SENSE_VCC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PB1     ------> ADC1_INP5
    */
    HAL_GPIO_DeInit(V_SENSE_5V_GPIO_Port, V_SENSE_5V_Pin);

    HAL_GPIO_DeInit(GPIOC, V_SENSE_ACT_PWR_Pin|I_SENSE_ACT_PWR_Pin);

    HAL_GPIO_DeInit(GPIOB, I_SENSE_3V3_Pin|V_SENSE_VCC_Pin);
